...
| N/A | Licensee Login Success | Licensee | AUTOMATED | `tests/test_login_licensee.py` | `test_licensee_can_log_in` |
| N/A | Licensee Login Failure (Invalid Credentials) | Licensee | AUTOMATED | `tests/test_login_licensee.py` | `test_licensee_cannot_log_in_with_invalid_credentials` |
