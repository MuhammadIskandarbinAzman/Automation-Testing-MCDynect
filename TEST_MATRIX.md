...
| T-LCSE-18-01 | MCD-LCSE-18 | Open delete sales modal from sales details (safe mode) | Licensee | `tests/licensee/test_licensee_delete_daily_sales_record.py` | `test_MCD_LCSE_18_delete_daily_sales_record` | Functional | Medium | PASS |
| T-LCSE-19-01 | MCD-LCSE-19 | Open Add Extra Sets Sale form and verify required fields | Licensee | `tests/licensee/test_licensee_add_extra_sets_sales.py` | `test_MCD_LCSE_19_add_extra_sets_sales_open_form` | Functional | Medium | PASS |
| T-LCSE-20-01 | MCD-LCSE-20 | Open Extra Sets sales details and verify key fields | Licensee | `tests/licensee/test_licensee_view_extra_sets_sales_details.py` | `test_MCD_LCSE_20_view_extra_sets_sales_details` | Functional | Medium | PASS |
